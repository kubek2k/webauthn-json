...
exports.createExtended = createExtended;
exports.createExtendedRequestFromJSON = createExtendedRequestFromJSON;
exports.createExtendedResponseToJSON = createExtendedResponseToJSON;
...
exports.getExtendedRequestFromJSON = getExtendedRequestFromJSON;
exports.getExtendedResponseToJSON = getExtendedResponseToJSON;
...
function _create() {
  _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(requestJSON) {
    var credential;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", createResponseToJSON(credential));
...
function _get() {
  _get = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(requestJSON) {
    var credential;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            return _context2.abrupt("return", getResponseToJSON(credential));
...
function createExtended(_x3) {
  return _createExtended.apply(this, arguments);
}

function _createExtended() {
  _createExtended = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(requestJSON) {
    var credential, json;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return navigator.credentials.create(createExtendedRequestFromJSON(requestJSON));

          case 2:
            credential = _context3.sent;
            json = createExtendedResponseToJSON(credential);
...
function getExtended(_x4) {
  return _getExtended.apply(this, arguments);
}

function _getExtended() {
  _getExtended = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(requestJSON) {
    var credential;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return navigator.credentials.get(getExtendedRequestFromJSON(requestJSON));

          case 2:
            credential = _context4.sent;
            return _context4.abrupt("return", getExtendedResponseToJSON(credential));
