...
function _create() {
  _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options) {
    var response;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            response.toJSON = function () {
              return createResponseToJSON(response);
            };
...
function _get() {
  _get = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(options) {
    var response;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            response.toJSON = function () {
              return getResponseToJSON(response);
            };
