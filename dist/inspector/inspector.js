    ...
    create(options) {
      return __async(this, null, function* () {
        return new Promise((resolve, reject) => {
          ...
          const json = convert(bufferToBase64url, credentialCreationOptionsExtended, options);
    ...
    get(options) {
      return __async(this, null, function* () {
        return new Promise((resolve, reject) => {
          ...
          const json = convert(bufferToBase64url, credentialRequestOptionsExtended, options);
